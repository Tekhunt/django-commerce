...
from . import views
from .views import CartDetail, CartList, LoginView, LogoutView, ProductsDetail, ProductsList, RegisterApi, User, UserView, UsersData, HomeView, VendorDetail, VendorList
